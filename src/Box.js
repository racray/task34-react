...
export function MiniDrawer({products,setProducts}) {
  ...
  return (
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open} className="drawer">
        ...
        <ListItem button key="Home">
          ...
          <ListItem button key="Product List">
            ...
            <ListItem button key="Adding Product">
            <ListItemIcon>
            <AddShoppingCartIcon color="primary"/>
              </ListItemIcon>
              <Link to="/ProductInput">Adding Product</Link>
            </ListItem>
      ...
      <Switch>
          <Route exact path="/">
            <Mvs products={products} setProducts={setProducts}/>  
          </Route>
          <Route exact path="/Pvs/:id">
            console.log(id);
          ...
          <Route exact path="/ProductInput">
            <ProductInput products={products} setProducts={setProducts}/>
          </Route>
